	...
	<div class="h-full px-4 py-6 lg:px-8">
		...
		<ScrollArea class="h-[340px]">
			<Table.Root>
				...
				<Table.Header>
					<Table.Row>
						<Table.Cell class="text-left">文件名</Table.Cell>
						<Table.Cell class="mb-4 mr-1 w-28">文件大小</Table.Cell>
						<Table.Cell class="w-28">上传进度</Table.Cell>
						<Table.Cell class="text-right">操作</Table.Cell>
					</Table.Row>
				</Table.Header>
				<Table.Body>
		...
		<div class="flex justify-end" style="margin-top: 20px">
			<Button class="w-32 text-xs" href="/knowledge/{knowledgeId}/create2">共1个文件|下一步</Button>
		</div>
		<!-- over -->
	</div>
</div>
