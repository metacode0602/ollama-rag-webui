<script lang="ts">
	import { tables, tabs } from '../data.js';
							...
							<Drawer.Root>
								...
								<Drawer.Content>
									<Drawer.Header class="flex justify-between ">
										<!-- -------------------------------------------------------- -->
										<div
											class="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 w-full h-auto">
											<div class="w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 ">
												...
												<form action="http://172.30.1.130:8080/datatasks" method="POST" enctype="multipart/form-data"
															class="dropzone-box "> <!-- 创建一个表单，用于文件上传 -->
													<div class="dropzone-area"> <!-- 文件上传区域 -->

														<Input type="file" id="upload-file "
																	 class="border-2 border-dashed border-gray-300 rounded-lg  mb-6 h-52 flex flex-col items-center justify-center dark:border-gray-600">
															<div class="file-upload-icon">
																<!-- <CirclePlus class="mr-2 h-4 w-4" /> -->
																<p class=" file-info text-gray-500 mb-4 dark:text-gray-400">
																	支持分类标签xlsx,html,pptx类型文件最多支持15个，单个文件最大100MB</p>
															</div>
													...
													<Table.Body>
														{#each tabs as tab, i (i)}
															<Table.Row class="">
																...
																<Table.Cell
																	class="font-medium text-xs  mb-4 mr-1 dark:text-gray-200 w-28">{tab.name}</Table.Cell>
																...
																<div class="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 w-full h-auto">
																	<div class="w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 ">
																		...
																		<div class="flex">
																			...
																			<!-- <Resizable.Handle /> -->
																			<div class="border rounded-lg overflow-hidden" style="width: 100%">
																				<Table.Root>
																					<Table.Header>
																						<Table.Row>
																		...
																		<div style="display: flex;align-items: center;justify-content: flex-end;margin-top: 20px">
																			...
																			<Drawer.Root>
																				<Drawer.Trigger asChild let:builder>
																					<Button builders={[builder]} class="w-32 text-xs" style="margin-left: 20px">下一步</Button>
																				</Drawer.Trigger>
																				<Drawer.Content>
																					<Drawer.Header class="flex justify-between ">
																						<!-- -------------------------------------------------------- -->
																						<div class="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900 w-full h-auto">
																							<div class="w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800 ">
																								...
																								<div class="flex justify-end mb-4" style="margin-top: 20px">
																									<Drawer.Close class="mb-2">
																										<Button variant="outline">上一步</Button>
																									</Drawer.Close>
																									<Button class="w-32 text-xs" style="margin-left: 20px">共3个文件|下一步</Button>
																								</div>
																							</div>
																						</div>
																					</Drawer.Header>
