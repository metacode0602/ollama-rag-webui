...
<div class="h-screen">
	...
	<div class=" h-5/6 w-full  border p-4">
    <Resizable.PaneGroup direction="horizontal" class=" w-screen rounded-lg  ">
        <Resizable.Pane defaultSize={50}>
            <ScrollArea class="h-full w-full rounded-md ">
                ...
                <!-- ----变量------ -->
                <div class="grid w-full gap-1.5 p-4  mt-4 border rounded-lg">
									...
									<Dialog.Content class="h-screen" style="max-width: max-content!important;">
										<div class="constructor">
											<div class="sidebar">
												...
												<div class="tab_list">
													<button class="{`tab_box ${tabIndex == 0 ? 'tab_box_sel':''}`}" on:click={()=>{tabSwitch(0)}}>
														全部
													</button>
													<button class="{`tab_box ${tabIndex == 1 ? 'tab_box_sel':''}`}" on:click={()=>{tabSwitch(1)}}>
														内置
													</button>
													<button class="{`tab_box ${tabIndex == 2 ? 'tab_box_sel':''}`}" on:click={()=>{tabSwitch(2)}}>
														自定义
													</button>
												</div>
												...
												<div class="sidebar_tools_list">
													{#each toolsList as item, i (i)}
														<button class="{`sidebar_tools_box ${sidebarToolsIdx == i ? 'sidebar_tools_box_sel':''}`}"
			...
			<Resizable.Pane defaultSize={50} >
				<ScrollArea class="h-full w-full rounded-md ">
					<div class="grid  gap-1.5 p-4  mx-2 border rounded-lg relative">
						<div class="flex items-center justify-between">
							<div class="flex items-center">
								<SquareMenu />
